...
export class AccessOptionController {
	...
	@MessagePattern({ cmd: 'accessOption.drop' })
	async drop(payload) {
		try {
	...
	@MessagePattern({ cmd: 'accessOption.dropMany' })
	...
	@MessagePattern({ cmd: 'accessOption.create' })
	...
	@MessagePattern({ cmd: 'accessOption.update' })
