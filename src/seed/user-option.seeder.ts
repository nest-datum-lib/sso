	...
	async send() {
		...
		try {
			...
			await Bluebird.each([{
				...
				id: 'happ-sso-user-option-facebook',
				userId: process.env.USER_ID,
				envKey: 'HAPP_SSO_USER_OPTION_FACEBOOK',
				name: 'Facebook',
				description: 'User facebook link.',
				dataTypeId: 'happ-data-type-text',
				isNotDelete: true,
			}, {
				id: 'happ-sso-user-option-linkedin',
				userId: process.env.USER_ID,
				envKey: 'HAPP_SSO_USER_OPTION_LINKEDIN',
				name: 'Linkedin',
				description: 'User linkedin link.',
				dataTypeId: 'happ-data-type-text',
				isNotDelete: true,
			}, {
				id: 'happ-sso-user-option-site',
				userId: process.env.USER_ID,
				envKey: 'HAPP_SSO_USER_OPTION_WEB_SITE',
				name: 'Web site',
				description: 'User web site.',
				dataTypeId: 'happ-data-type-text',
				isNotDelete: true,
			}, {
				id: 'happ-sso-user-option-phone',
				userId: process.env.USER_ID,
				envKey: 'HAPP_SSO_USER_OPTION_WEB_SITE',
				name: 'Phone',
				...
				id: 'happ-sso-user-option-position',
				userId: process.env.USER_ID,
				envKey: 'HAPP_SSO_USER_OPTION_POSITION',
				name: 'Position',
				description: 'User job position.',
				dataTypeId: 'happ-data-type-text',
				isNotDelete: true,
			}, {
				id: 'happ-sso-user-option-location',
				userId: process.env.USER_ID,
				envKey: 'HAPP_SSO_USER_OPTION_LOCATION',
				name: 'Location',
